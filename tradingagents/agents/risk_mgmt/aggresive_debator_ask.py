...
def create_risky_debator_ask(llm):
...
Your task is to:
1. Question the Safe/Conservative Risk Analyst's position.
2. Analyze the trader's decision and market conditions.
3. Build a compelling case for aggressive risk-taking.
4. Address concerns raised by conservative and neutral analysts in previous rounds.
5. Provide specific evidence and reasoning for high-reward strategies.
6. Consider the debate context and previous arguments.
7. Maintain an optimistic but data-driven tone.

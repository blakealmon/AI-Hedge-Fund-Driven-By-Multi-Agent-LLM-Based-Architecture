...
def create_safe_debator_ans(llm):
    def safe_node(state) -> dict:
        ...
        json_format = '''{
  "answers": [{
      "rebuttal": "...", // Answer to the aggressive's question
      "question": "..." // Question that the aggressive asked
  }, ...]
}'''
...
Your task is to:
1. Answer the aggressive's question directly, providing a clear and concise rebuttal.
2. Address the aggressive's concerns with specific evidence from the provided data.
3. Maintain a cautious and data-driven tone, emphasizing risk mitigation and stability.

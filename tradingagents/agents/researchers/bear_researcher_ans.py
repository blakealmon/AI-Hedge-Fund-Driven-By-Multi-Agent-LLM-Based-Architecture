...
def create_bear_researcher_ans(llm, memory):
    def bear_researcher_ans_node(state) -> dict:
        ...
        json_format = """{
  "answers": [{
      "rebuttal": "...", // Answer to the bull's question
      "question": "..." // Question that the bull asked
  }, ...]
}"""

        prompt = f"""You are a Bear Analyst participating in a cross-examination of the Bull Analyst's arguments. Your goal is to critically analyze the bull's response and provide strong rebuttals to their claims.
...
{json_format}
The content of the rebuttals should be detailed and evidence-based. Source indicates where the information was obtained from, such as the bull's response or past reflections.
"""

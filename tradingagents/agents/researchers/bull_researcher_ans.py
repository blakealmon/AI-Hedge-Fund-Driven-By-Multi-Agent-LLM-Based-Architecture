...
def create_bull_researcher_ans(llm, memory):
  ...
  "answers": [{
      ...
      "question": "..." // Question that the bear asked
        ...
        prompt = f"""You are a Bull Analyst participating in a cross examination against the Bear Analyst. Your goal is to provide strong rebuttals to their claims.
...
{json_format}
The content of the rebuttals should be detailed and evidence-based. Source indicates where the information was obtained from, such as the bear's response or past reflections.
"""
